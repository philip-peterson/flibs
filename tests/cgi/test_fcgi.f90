...
program test_fcgi
    ...
    !open(unit=unitNo, file='fcgiout', status='unknown') ! file 'fcgiout' will show %REMARKS%
...
contains
    ...
    subroutine respond ( dict, unitNo, stopped )
        ...
        i = fcgip_put_string ('Content-type: text/html'//CRLF//NUL)
