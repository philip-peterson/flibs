! test_f0noIEEE.f90 --
!     Test program for the leadzero module - version: no IEEE support for NaN and Inf
!
...
program tryf0
  ...
  real(p1) :: p1x(3) = (/-zero1,huge(zero1),0.2_p1/)
  real(p2) :: p2x(3) = (/-zero2,huge(zero2),0.2_p2/)
  integer  :: n
  do n = 0,2,2
     call revealp1(p1x,n)
     call revealp2(p2x,n)
